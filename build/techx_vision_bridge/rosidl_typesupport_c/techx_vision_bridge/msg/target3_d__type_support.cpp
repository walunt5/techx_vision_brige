...
static const _Target3D_type_support_symbol_names_t _Target3D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, techx_vision_bridge, msg, Target3D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, techx_vision_bridge, msg, Target3D)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, techx_vision_bridge, msg, Target3D)() {
  return &::techx_vision_bridge::msg::rosidl_typesupport_c::Target3D_message_type_support_handle;
}
