...
bool techx_vision_bridge__msg__target3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("techx_vision_bridge.msg._target3_d.Target3D", full_classname_dest, 43) == 0);
  }
  techx_vision_bridge__msg__Target3D * ros_message = _ros_message;
  {  // header
  ...
  {  // track_id
    ...
    ros_message->track_id = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // x
...
{
  /* NOTE(esteve): Call constructor of Target3D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("techx_vision_bridge.msg._target3_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Target3D");
